...
(function () {
  ...
  // api/game/keno.py. Missing hit counts pay 0.
  const SHAPE = {
    1: { 1: 1 },
    2: { 2: 1 },
    3: { 2: 0.5, 3: 1 },
    4: { 2: 0.3, 3: 1, 4: 3 },
    5: { 3: 1, 4: 3, 5: 10 },
    6: { 3: 0.7, 4: 2, 5: 8, 6: 30 },
    7: { 4: 1.5, 5: 5, 6: 20, 7: 80 },
    8: { 5: 3, 6: 12, 7: 50, 8: 200 },
    9: { 5: 2, 6: 6, 7: 25, 8: 100, 9: 500 },
    10: { 5: 2, 6: 5, 7: 20, 8: 80, 9: 400, 10: 1000 },
  };
